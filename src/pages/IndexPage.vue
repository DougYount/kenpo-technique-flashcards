    ...
    <q-card flat bordered style="width: 800px; max-width: 800px">
      <q-card-section>
        ...
        <q-card-section>
          <div class="row">
            <div class="col">
              <q-scroll-area class="techniques-card">
            ...
            <div class="col text-left">
              ...
              <div class="row">
                <div class="col q-ml-lg">
                  <q-checkbox v-model="store.randomizeTechniques" label="Randomize Order" />
                </div>
              </div>
              <div class="row">
                <div class="col q-ml-lg">
                  <q-checkbox v-model="store.displayOpponentInteraction" label="Display Opponent Interaction" />
                </div>
              </div>
            </div>
          </div>
      ...
      <q-card-actions align="right">
        ...
        <q-btn
          color="primary"
          label="Generate"
          :disable="store.getFilteredTechniques.length < 1"
          :to="{ name: 'FlashCards' }"
        />
      </q-card-actions>
    </q-card>
